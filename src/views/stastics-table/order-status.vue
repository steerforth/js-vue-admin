<template>
  <div class="app-container">
    <sticky :z-index="10" :class-name="'sub-navbar '+ HeaderCss">
      <el-cascader style='width:320px;margin-right: 5px;'
      	:options="optionsForMulti"
      	:props="propsForMulti"
        placeholder="请选择投放人/站点"
      	collapse-tags
      	clearable
      ...
      <el-select v-model="condition.targetMarket" placeholder="请选择目标市场" style='margin-right: 5px;'>
          <el-option
            v-for="item in optionsForShopArea"
            :key="item"
            :label="item"
            :value="item">
          </el-option>
      ...
      <el-button icon="el-icon-search" circle @click="reloadTable"></el-button>
    ...
    <el-table
      ...
      <el-table-column
        prop="orderNumAfterCheck"
        label="审单后/单"
    	header-align="center"
    	align="center">
      </el-table-column>
      <el-table-column
        prop="adCostAvgAfterCheck"
        label="审单成功转化成本(USD)"
    	header-align="center"
    	align="center">
      </el-table-column>
      <el-table-column
    	...
    	align="center">
    	<el-table-column
    	  prop="directType" label="直邮"
    	  header-align="center" align="center">
    	</el-table-column>
    	<el-table-column
    	  prop="distributionType" label="仓配"
    	  header-align="center" align="center">
    	</el-table-column>
    	<el-table-column
    	  prop="forwardType" label="转寄"
    	  header-align="center" align="center">
    	</el-table-column>
      </el-table-column>
      <el-table-column
    	...
    	align="center">
    	<el-table-column
    	  prop="distributionStatus" label="配送中"
    	  header-align="center" align="center">
    	</el-table-column>
    	<el-table-column
    	  prop="successStatus" label="已签收"
    	  header-align="center" align="center">
    	</el-table-column>
    	<el-table-column
    	  prop="failedStatus" label="拒签"
    	  header-align="center" align="center">
    	</el-table-column>
      </el-table-column>
      <el-table-column
    	...
    	align="center">
    	<el-table-column
    	  prop="settled" label="单数/单"
    	  header-align="center" align="center">
    	</el-table-column>
    	<el-table-column
    	  prop="settledTotal" label="结算款/元"
    	  header-align="center" align="center">
    	</el-table-column>
      </el-table-column>
    </el-table>
...
import { shopList } from '@/api/shopService'
import { deliverStatistic } from '@/api/orderService'
import '@/utils/date'
import TableParam from '@/utils/dynamic-table'
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      tableHeight: TableParam.DEFAULT_TABLE
    }
  },
  beforeMount() {
  ...
  mounted() {
    ...
    // alert('nav bar:'+TableParam.NAV_BAR)
    // alert('padding bottom:'+TableParam.PADDING_BOTTOM)
    // alert('diff:'+TableParam.DIFF)
  	//navBar:50 offsetTop:68 bottom:20
  	this.$nextTick(() => {
  		this.$set(this, 'tableHeight', window.innerHeight -this.$refs.table.$el.offsetTop - TableParam.NAV_BAR - TableParam.PADDING_BOTTOM - TableParam.DIFF);
  	})
  	window.onresize = () => {
  		return (() => {
  			this.$set(this, 'tableHeight', window.innerHeight -this.$refs.table.$el.offsetTop - TableParam.NAV_BAR - TableParam.PADDING_BOTTOM - TableParam.DIFF);
